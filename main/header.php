...
<head>
        ...
        <title>REALESTATEAUCTIONX</title>
...
<li><a href="viewbillingcustomer.php">View Trasaction</a></li>
		...
		<li class="drodown-show"><a href="#"> My Properties <i class="fa fa-angle-down"></i></a>
			<ul class="open-dropdown setting">
				<li><a href="selectcategory.php">Add Property</a></li>
				<li><a href="viewproduct.php">View Property</a></li>
			</ul>
		</li>
	...
	?>
		...
		<li class="drodown-show"><a href="#"> Reverse Property <i class="fa fa-angle-down"></i></a>
			<ul class="open-dropdown setting">
				<li><a href="selectreversebidcategory.php">Add Property</a></li>
				<li><a href="viewreverseproduct.php">View Property</a></li>
			</ul>
		</li>
		...
		<li class="drodown-show"><a href="#"> Report <i class="fa fa-angle-down"></i></a>
			<ul class="open-dropdown setting">
				...
				<li><a href="viewproduct.php">View properties</a></li>
			</ul>
		</li>
		<li class="drodown-show"><a href="#"> My account <i class="fa fa-angle-down"></i></a>
			<ul class="open-dropdown setting">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="hot-line-area">
                                    <div class="phone">
                                        Customer Support: <span>+91-8302899928 </span>
                                    </div>
                                </div>
                                <!-- hot-line-area end -->
		...
		<div class="slider-wrapper" style="background-image:url(img/slider/home-2-02.jpg);width: 100%;">
			<div class="container-fluid">
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
							<h1 class="title1"><span class="text">RealEstateAuctionX</span> </h1>
							<p>India's top rated auction platform..</p>
							<div class="slier-btn-1">
