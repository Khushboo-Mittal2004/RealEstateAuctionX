                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12 plr-0">
                            <div class="contact-address-area">
                                ...
                                <ul>
                                    <li>
                                        <i class="fa fa-fax">&nbsp;</i> Address :RealEstateAuctionX, Bennett University, Plot Nos 8-11, TechZone II, Greater Noida 201310, UP, India. </li>
                                    <li>
                                        <i class="fa fa-phone">&nbsp;</i> +91-8302899928</li>
                                    <li>
                                        <i class="fa fa-envelope-o"></i>&nbsp;deepanshujalan@gmail.com</li>
                                </ul>
                            </div>
                        </div>
