	...
	<div class="col-md-8">
		<table class="table table-striped table-bordered">
			<tbody>
				...
				<tr>
					<th>Property Code :</th><td><?php echo $rsproduct['product_id']; ?></td>
				</tr>
				<tr>
					<th>Address</th><td><?php echo $rsproduct['product_warranty']; ?></td>
				</tr>
				<tr>
...
<div class="row">
	<div class="col-md-12">
<p><b>Location :</b> <?php echo $rsproduct['product_delivery']; ?></p>
	</div>
</div>
<hr>
...
function countdowntimer(id, time)
{
		...
		if (distance < 0) {
			...
			document.getElementById("countdowntime"+id).innerHTML = "<center><b  style='color: red;'>EXPIRED</b></center>";
                                            ...
                                            <div class="price-box">
<p><b>Actual property cost</b> : ₹<?php echo $rsproduct['product_cost']; ?></p> <h4>Current Bid Amount : <br>₹<?php echo $rsproduct['ending_bid']; ?></h4>

<h4>Rank 1(Current BID WITH) <?php echo $rsbidding['customer_name']; ?> <?php echo $rsbidding['customer_id']; ?>
<?php
		if(mysqli_num_rows($qsqledit) == 0)
		{
			echo "<center><b style='color: red;'>No biddings done yet..</b></center>";
		...
		while($rsedit= mysqli_fetch_array($qsqleditbidding))
		{
		echo "$rsedit[customer_name] bidded ₹". $rsedit['bidding_amount'] ." <hr>";
		}
	?>
<input type='hidden' name='max_bid_amt' id='max_bid_amt' value='<?php echo $rsproduct['ending_bid']+100000; ?>'>
...
<div id="divbidstatus">
	<div class="w3_agileits_card_number_grid_left">
		<div class="controls">
			<label class="control-label">You can't bid for own property..</label>
		</div>
	</div>
</div>
<?php
...
<div id="divbidstatus">
	<div class="w3_agileits_card_number_grid_left">
		<div class="controls">
			...
			<input name="purchase_amount" id="purchase_amount" class="form-control" type="number" placeholder="Enter amount" style="width:200px;" autocomplete="off"  min="10000" step="10000">		
		
		</div>
	</div> <br>
	<div class="snipcart-details agileinfo_single_right_details">
			<fieldset>
				<input type="submit" name="submit" value="Bid Now" class="form-control" style="width: 250px;"  onclick="bidding()" />
			</fieldset>
	</div>
</div>
<?php
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="section-title-3">
                                <h2>Similar properties under <?php echo $rsproduct['category_name']; ?>:</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
