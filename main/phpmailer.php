...
function sendmail($tomail, $totmailname , $subject, $message)
{
	...
	$smtpport 	= 587;
	$mailsender = "RealEstateAuctionX";
	$companyname= "RealEstateAuctionX";
	$facebook = "https://www.facebook.com/RealEstateAuctionX";
	$twitter = "https://www.twitter.com/RealEstateAuctionX";
	$youtube = "https://www.youtube.com/RealEstateAuctionX";
	$linkedin = "https://www.linkedin.com/RealEstateAuctionX";
	$companyaddress  = "RealEstateAuctionX, Bennett University,Plot Nos 8-11, TechZone II, Greater Noida 201310, UP, India | Email us: deepanshujalan@gmail.com";
	$contactno = "+91-8302899928";
	$url = "www.RealEstateAuctionX.com";
