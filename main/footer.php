                            ...
                            <div class="col-custom">
                                <div class="single-service">
                                    ...
                                    <div class="serivce-cont">
                                        <h3>Free Confirmation</h3>
                                        <p>Free Confirmation on all winning Bid</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-custom">
...
?>
                                        ...
                                        <div class="col-lg-5 offset-xl-1 col-md-6 col-sm-6">
                                            ...
                                            <div class="block-contact-text">
                                                <p> RealEstateAuctionX<br>Bennett University, Plot Nos 8-11, TechZone II, Greater Noida 201310, UP <br>India</p>
                                                <p>Call us: <span>+91-8302899928 </span></p>
                                                <p>Email us: <span>deepanshujalan@gmail.com</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright">Copyright &copy; RealEstateAuctionX. All Rights Reserved</div>
                            </div>	
                            <div class="col-lg-6 col-md-6">
