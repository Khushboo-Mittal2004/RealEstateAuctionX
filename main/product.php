...
?>
		...
		<div class="col-md-6 col-lg-6">
			...
			<input class="form-control" type="text" name="product_name" id="product_name" placeholder="Property name" value="<?php echo $rsedit['product_name']; ?>">
		</div>
	</div>
	<div class="row">
		<div class="col-md-12 col-lg-12">
			...
			<textarea name="product_description" id="product_description" type="text" placeholder="Property description" class="form-control" style="height: 250px;"><?php echo $rsedit['product_description']; ?></textarea>
		</div>
	</div>
...
function removediv(x)
{
	...
	<div class="row">
		...
		<div class="col-md-6 col-lg-6">		
			<label class="control-label">Property cost</label>
	...
	<div class="row">
		<div class="col-md-6 col-lg-6">		
			...
			<select name="product_delivery" id="product_delivery" class="form-control" >
				...
				<?php
				$arr = array("Noida","Delhi","Jaipur","Gurgaon","Mumbai");
				foreach($arr as $val)
				{
		...
		<div class="col-md-6 col-lg-6">		
			...
			<input name="product_warranty" id="product_warranty" class="form-control" type="text" placeholder="Address" value="<?php echo $rsedit['product_warranty']; ?>">
		</div>
		<div class="col-md-6 col-lg-6">		
...
function validateform()
{
	...
	{
		document.getElementById("idproduct_name").innerHTML ="Property name should contain only alphabets and spaces....";	
		i=1;		
	}
	if(document.getElementById("product_name").value.length < 5)
	{
		document.getElementById("idproduct_name").innerHTML ="Property name should contain more than 10 characters....";	
		i=1;		
	}
	if(document.getElementById("product_name").value.length > 100)
	{
		document.getElementById("idproduct_name").innerHTML ="Property name should contain less than 20 characters....";	
		i=1;		
	}
	if(document.getElementById("product_name").value == "")
	{
		document.getElementById("idproduct_name").innerHTML ="Property name should not be empty....";	
		i=1;		
	}
	...
	if(document.getElementById("product_cost").value < 1000)
	{
		document.getElementById("idproduct_cost").innerHTML ="Property cost should be more than RS.100....";	
		i=1;		
	}
	
	if(document.getElementById("product_cost").value == "")
	{
		document.getElementById("idproduct_cost").innerHTML ="Property cost should not be empty....";	
		i=1;		
	}
	
	if(document.getElementById("product_warranty").value=="")
	{
		document.getElementById("idproduct_warranty").innerHTML ="Address should not be empty..";	
		i=1;		
	}
	
	if(document.getElementById("product_delivery").value=="")
	{
		document.getElementById("idproduct_delivery").innerHTML ="location should not be empty....";	
		i=1;		
	}
